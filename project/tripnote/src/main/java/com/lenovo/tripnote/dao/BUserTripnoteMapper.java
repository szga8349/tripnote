...
public interface BUserTripnoteMapper {
	...
	List<BUserTripnoteResultVo> queryCondition(@Param("record")BUserTripnoteSearchVo search);
	

	Integer queryCountCondition(@Param("record")BUserTripnoteSearchVo search);
}