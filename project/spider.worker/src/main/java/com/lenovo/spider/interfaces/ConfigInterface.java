...
public class ConfigInterface {
    ...
    public static List<SiteInfo> selectSite() throws NetException {
        ...
        JSONObject result = HttpUtil.postStr(baseUrl + "/siteInfo/selectForSpider", map);
     ...
     * @date 2017年12月7日 下午1:53:03
     */
    public static List<SiteInfo> selectAllSite() throws NetException {
        Map<String, String> map = new HashMap<>();
        map.put("pageSize", String.valueOf(Integer.MAX_VALUE));
    ...
    public static void setIpSleeping(IpInfo ip, int minutes) {
        ...
        if (ip == null || ip.getDeadline() == null || System.currentTimeMillis() >= DateUtil.parse(ip.getDeadline()).getTime() - minutes * 60 * 1000) {
            return;
        }
