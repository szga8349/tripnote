...
public class SeleniumUtil {
     ...
     * @param by
     */
    public static WebElement waitForLoad(final WebDriver driver, final By by){
        return new WebDriverWait(driver, timeout, interval).until(new ExpectedCondition<WebElement>() {
     ...
     * @param by
     */
    public static WebElement waitForLoad(final WebDriver driver, final WebElement container, final By by){
    	return new WebDriverWait(driver, timeout, interval).until(new ExpectedCondition<WebElement>() {
    		public WebElement apply(WebDriver d) {
    			WebElement sub = container.findElement(by);
    			return sub;
    		}
    	});
    }
