...
abstract class StructuralEvaluator extends Evaluator {
    ...
    static class Child extends StructuralEvaluator {
        public Child(Evaluator evaluator) {this.evaluator = evaluator;}
    ...
    static class Self extends StructuralEvaluator {
        public Self(Evaluator evaluator) {this.evaluator = evaluator; }

        @Override
        public boolean matches(Element root, Element element) {
            // 针对单一节点Document类型也会包装一层#root，所以不能是Document类型
            return !(element instanceof Document) && this.evaluator.matches(root, element);
        }
    }
}
