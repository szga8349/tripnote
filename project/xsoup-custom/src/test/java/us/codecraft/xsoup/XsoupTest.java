...
public class XsoupTest {
    ...
    @Test
    public void testSelfEvaluator() {
        String html = "<div><a href=\"https://github.com\" target=\"_blank\" >github.com</a></div>";

        Element element = Jsoup.parse(html);
        String result = Xsoup.select(element, "//div/a/self::*/@href").get();
