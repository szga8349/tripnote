...
public class ACEEncryptionUtils {
	private static final String LENOVO_PASSWORD = "com.lenovo.ace";
	...
	public static String encrypt(String content){
		return encrypt(content,LENOVO_PASSWORD);
	}
	public static String decrypt(String content){
		return decrypt(content,LENOVO_PASSWORD);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("加密后长度：" + s.length());
		// 解密
